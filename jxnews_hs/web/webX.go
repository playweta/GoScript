...
// var urlGet = fmt.Sprint(t, "sign_do.html?p=cH_App_zgwxRB_7F&name=%E5%88%98%E7%82%B3%E8%8D%A3&tel=15970645022&cip=", cip, "&area=360112&institution=", institution)
var urlGet = fmt.Sprint(t, "sign_do.html?p=cH_App_zgwxRB_7F&name=%E5%8F%B6%E5%9F%8E&tel=15970645399&area=360112&institution=", institution)
...
func WebX() {
	...
	// 创建一个一个定时器
	fmt.Println("定时器开始")
	myT := time.NewTimer(30.6554 * 1000 * 1000 * 1000) // 设置7秒后执行一次
	<-myT.C
